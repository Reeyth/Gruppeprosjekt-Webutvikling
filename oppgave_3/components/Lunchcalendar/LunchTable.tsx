                        ...
                        {week.map((day: Day) => {
                            return (
                                <tr key={day.id}>
                                    ...
                                    <td>{day?.day}</td>
                                    {day?.overwrite_employee != null ? (<td><Link href={`/employee/${day?.overwrite_employee_id}`}>{day?.overwrite_employee}</Link></td>)
                                    : <td className="employeeName"><Link href={`/employee/${day?.employee_id}`}>{day?.employee_name}</Link></td>}
